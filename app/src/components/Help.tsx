							...
							<div className="flex flex-col gap-2">
									...
									<Text>
										...
										<ul className="list-disc list-inside">
											...
											<li>
												...
												for the full list. Subtypes can be searched by separating them with middle dots, e.g.
												名詞・固有名詞.
											</li>
										</ul>
									</Text>
								...
								<div className="flex flex-col gap-2">
									...
									<Text>
										...
										<br />
										English translations are not checked for accuracy. For some data sources which do not manually align
										their translations, some sentences may not have the correct translation included.
									</Text>
								</div>
								<div className="flex flex-col gap-2">
									<Heading level={2} className="text-xl font-bold">
									...
									<Text>
										...
										<a
											href="https://github.com/1Computer1/sengenbango/"
											className="text-blue-600 dark:text-blue-400 underline"
										>
											Github
										</a>{' '}
								...
								<div className="flex flex-col gap-2">
									...
									<Text>
										<ul className="list-disc list-inside text-xs">
											<li>
												<span className="font-bold font-mono mr-1">tatoeba</span> User written sentences and
												translations.{' '}
											...
											<li>
												<span className="font-bold font-mono mr-1">kyoto</span> Sentences from Japanese Wikipedia
												articles about Kyoto.{' '}
												<a
											...
											<li>
												<span className="font-bold font-mono mr-1">bpersona-ja-en bpersona-en-ja</span> Conversations in
											...
											<li>
												<span className="font-bold font-mono mr-1">wordnet-def wordnet-exe</span> Definitions and
												examples from the WordNet project.{' '}
												<a
											...
											<li>
												...
												<a
													href="http://www.phontron.com/jaen-law/"
													className="text-blue-600 dark:text-blue-400 underline"
												>
