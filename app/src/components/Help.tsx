		...
		>
			...
			<div className="flex flex-col gap-2">
				...
				<Text>
					...
					<a href="https://github.com/tanreinama/gpt2-japanese" className="text-blue-600 dark:text-blue-400 underline">
						gpt2-japanese
					</a>{' '}
			...
			<div className="flex flex-col gap-2">
				...
				<Text>
					<ul className="list-disc list-inside text-xs">
						...
						<li>
							<span className="font-bold font-mono mr-1">natcom</span> Abstrasts of articles from Nature Communications.{' '}
							<a
